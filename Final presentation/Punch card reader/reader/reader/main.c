...
//*****************Getting the quantity************************************
	...
	{
		LCD_String_xy(2,0 ," Qty   5mg  ");  
	
	}else if(q3<800 && q2>800 && q1<800 )   //010  Qty 100mg
	{
		LCD_String_xy(2,0 ," Qty   100mg  "); 
		
	}else if(q3<800 && q2>800 && q1>800 )
	{
		LCD_String_xy(2,0 ," Qty   200mg  ");  //011 Qty 200mg
	
	}else if(q3>800 && q2<800 && q1<800 )
	{
		LCD_String_xy( 2,0 ," Qty   500mg  ");  //100  Qty 500mg
		
	}else if(q3>800 && q2<800 && q1>800 )
	{
		LCD_String_xy( 2,0 ," Qty   150mg  "); //101  Qty 150mg
		
	}else if(q3>800 && q2>800 && q1<800 )
	{
		LCD_String_xy( 2,0 ," Qty   250mg  ");;  //110  Qty 250mg
